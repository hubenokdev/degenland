...
export default function HashConnectProvider({
  ...
  return (
    <HashConnectAPIContext.Provider
      value={{ walletData: saveData, installedExtensions, connect, disconnect, sendHbarAndNftToTreasury, sendHbarToTreasury, sendPALToTreasury, autoAssociate, receiveNft, sendHbarAndMultiNftsToTreasury, receiveMultipleNfts }}>
      {children}
    </HashConnectAPIContext.Provider>
  );
}
