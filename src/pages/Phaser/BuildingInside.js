...
import { getPlaceInfo, setPlaceInfo, setCustomer, updatePlaceInfo, setTeleportData } from '../../actions/placeinfo';
import { addChatHistory, setChatContent, setEmoji } from '../../actions/chat';
import { calculateLevel, setDancing } from '../../actions/playerinfo';
...
class BuildingInside extends Phaser.Scene {
  ...
  create() {
    ...
    this.socket.on("newPlayerInside", async (playerInfo) => {
