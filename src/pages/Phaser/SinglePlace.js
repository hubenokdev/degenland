...
import { setBuilding, setRoad, setGround, setObject } from '../../actions/construction';
...
class SinglePlace extends Phaser.Scene {
  ...
  _setInteractive(target, bulType) {
    ...
    if (this.buildingInfo[bulType].type == 'building') {
      if (this.buildingInfo[bulType].size == '9*11')
        ...
        if (this.buildingInfo[bulType].index == 20)
          shape = new Phaser.Geom.Polygon([
            175, 395,
            175, 1085,
            510, 1275,
        ...
        else if (this.buildingInfo[bulType].index == 21)
          shape = new Phaser.Geom.Polygon([
            180, 370,
            210, 490,
            115, 475,
        ...
        else if (this.buildingInfo[bulType].index == 22)
          shape = new Phaser.Geom.Polygon([
            300, 170,
            295, 380,
            195, 415,
      ...
      if (this.buildingInfo[bulType].index == 26) {
        shape = new Phaser.Geom.Polygon([
          65, 30,
          75, 135,
          175, 130,
      ...
      else if (this.buildingInfo[bulType].index == 27) {
        shape = new Phaser.Geom.Polygon([
          65, 0,
          10, 105,
          100, 180,
      ...
      else if (this.buildingInfo[bulType].index == 28) {
        shape = new Phaser.Geom.Polygon([
          125, 0,
          20, 60,
          10, 130,
      ...
      else if (this.buildingInfo[bulType].index == 30) {
        shape = new Phaser.Geom.Polygon([
          55, 65,
          55, 155,
          95, 175,
      ...
      else if (this.buildingInfo[bulType].index == 31) {
        shape = new Phaser.Geom.Polygon([
          90, 0,
          85, 35,
          45, 60,
  ...
  create() {
    ...
    this.socket.on("mapInit", async (buildingList) => {
      ...
      this._buildingPlacement(buildingList);
    });

    this.socket.on("changeMap", async (newBuilding) => {
      console.log("-----------------changeMap---------------------", newBuilding);
  ...
  _changeMap(newBuilding) {
    ...
    this.buildingSetting(sizex, sizey, type, newBuilding);
  ...
  buildingSetting(sizex, sizey, type, building) {
    ...
    let newBuilding = new Building(this, bud, "placement", tileID, type - 1);
  ...
  update() {
    //    console.log("update", this.currentBuilding);
    if (this.currentBuilding != undefined) {
  ...
  addEvents() {
    ...
    this.input.on('pointermove', (pointer) => {
      //      console.log("singleplace", this.currentBuilding);
      if (this.currentBuilding != undefined)
