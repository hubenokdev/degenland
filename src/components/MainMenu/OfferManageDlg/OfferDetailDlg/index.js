          ...
          }
          {
            ...
            <Button
              ...
              onClick={async () => {
                ...
                const result = await onClickApproveNfts(offerInfo._id, "receiver", offerInfo.receiverNfts, offerInfo.receiverToken.hbar, offerInfo.receiverToken.pal);
                if (result == true) {
